...
LEVELS = {
    "P1": {"topics": ["Numbers to 10", "Addition & Subtraction", "Word Problems"]},
    "P2": {"topics": ["Numbers to 1000", "Addition & Subtraction", "Word Problems"]},
    "P3": {"topics": ["Multiplication & Division", "Fractions", "Angles & Lines",
                      "Data & Graphs", "Word Problems"]},
    "P4": {"topics": ["Fractions", "Angles & Geometry", "Whole Numbers",
                      "Decimals", "Data & Tables", "Word Problems"]},
    "P5": {"topics": ["Triangles & Area", "Volume", "Fractions",
                      "Ratio", "Decimals & Measurement", "3D Solids & Views",
                      "Whole Numbers", "Word Problems"]},
    "P6": {"topics": ["Whole Numbers", "Fractions", "Decimals", "Percentage",
